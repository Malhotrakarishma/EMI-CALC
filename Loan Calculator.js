...
//   const Processingfees= 25/10000;
const Processingfees=3999;
  const gst= 5;
...
const totalInterest = (principal* Processingfees).toFixed(2);

  //Compute Total Payment

//   const totalPayment = (monthly * calculatedPayments).toFixed(2);

   const totalPayment = (totalInterest *gst/100).toFixed(2);
   const Netcredit= (principal-totalInterest-totalPayment).toFixed(2);
  ...
  document.getElementById("NetCredit").innerHTML = "₹ " + Netcredit;
    e.preventDefault();
}
